...
{
    public class DiversifiedLeverageTrump2025 : QCAlgorithm
    {
        ...
        {
            // Trump's Second Term: January 20, 2025 - Current (July 18, 2025)
            SetStartDate(2025, 01, 20); // Trump's second inauguration date
            SetEndDate(2025, 07, 18); // Current date
            ...
            Log($"=== TRUMP 2025-CURRENT PERIOD ANALYSIS ===");
        ...
        {
            Log($"=== TRUMP 2025-CURRENT PERIOD FINAL RESULTS ===");
            ...
            Log($"=== INDIVIDUAL ETF PERFORMANCE (Trump 2025-Current) ===");
            foreach (var symbol in _symbols)
            {
            ...
            Log($"=== TRUMP 2025-CURRENT PERIOD SUMMARY ===");
