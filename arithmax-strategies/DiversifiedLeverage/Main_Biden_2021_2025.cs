...
{
    public class DiversifiedLeverageBiden2021 : QCAlgorithm
    {
        ...
        {
            // Biden Term: January 20, 2021 - January 20, 2025
            SetStartDate(2021, 01, 20); // Biden inauguration date
            SetEndDate(2025, 01, 20); // End of Biden's term
            ...
            Log($"=== BIDEN 2021-2025 PERIOD ANALYSIS ===");
        ...
        {
            Log($"=== BIDEN 2021-2025 PERIOD FINAL RESULTS ===");
            ...
            Log($"=== INDIVIDUAL ETF PERFORMANCE (Biden 2021-2025) ===");
            foreach (var symbol in _symbols)
            {
            ...
            Log($"=== BIDEN 2021-2025 PERIOD SUMMARY ===");
